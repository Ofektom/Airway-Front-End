...
const AddFlightForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch('http://localhost:8080/api/v1/flights/add-flight', {
                method: 'POST',
                headers: {
    ...
    const handleChange = (e, index, classNameIndex) => {
        ...
        if (classNameIndex !== undefined) {
            // Handle changes for fields within the classes array
            ...
            // Handle changes for fields within the main form except classes
